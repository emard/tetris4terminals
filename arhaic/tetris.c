...
unsigned char rotated_block_pattern[] = {
  ...
  */
  ...
  0x4C, /* 10:0b 0100 1100 */
  0x40, /* 11:0b 0100 0000 */

  0x4E, /* 12:0b 0100 1110 */
  0x00, /* 13:0b 0000 0000 */

  0x46, /* 14:0b 0100 0110 */
  0x40, /* 15:0b 0100 0000 */

  /* cyan 1x4 block */
  0x44, /* 16:0b 0100 0100 */
  0x44, /* 17:0b 0100 0100 */

  0x0F, /* 18:0b 0000 1111 */
  0x00, /* 19:0b 0000 0000 */

  0x44, /* 20:0b 0100 0100 */
  0x44, /* 21:0b 0100 0100 */

  0x0F, /* 22:0b 0000 1111 */
  0x00, /* 23:0b 0000 0000 */
   ...
   *  .x
   */
  0x0E, /* 40:0b 0000 1110 */
  0x20, /* 41:0b 0010 0000 */

  /*   x
   *  .x
   *  xx
   */
  0x02, /* 42:0b 0000 0010 */
  0x26, /* 43:0b 0010 0110 */

  /*
   * x.
   * xxx
   */
  0x00, /* 44:0b 0000 0000 */
  0x8E, /* 45:0b 1000 1110 */

  /* xx
   * x.
   * x
   */
  0x0C, /* 46:0b 0000 1100 */
  0x88, /* 47:0b 1000 1000 */
  ...
  0x80, /* 49:0b 1000 0000 */

  /*  xx
   *  .x
   *   x
   */
  0x06, /* 50:0b 0000 0110 */
  0x22, /* 51:0b 0010 0010 */

  /*  .x
   * xxx
   */
  0x00, /* 52:0b 0000 0000 */
  0x2E, /* 53:0b 0010 1110 */

  /* x
   * x.
   * xx
   */
  0x08, /* 54:0b 0000 1000 */
  0x8C, /* 55:0b 1000 1100 */
};
